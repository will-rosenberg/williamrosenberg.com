  ...
  return (
    ...
    >
      <div className="maindiv">
        ...
        <p style={{ textAlign: "center", marginTop: "20px" }}>
          Built a client-facing full-stack web app for accent analysis &
          training.
          <br />
          <span
            style={{
          ...
          <div className="app-showcase">
            <div className="app-links">
              ...
              <a
                href="https://youtu.be/1I5FPCRFm7o"
                target="_blank"
                onClick={() =>
                  trackEvent("Demo Video Click", { source: "app_showcase" })
                }
              >
                📹 Watch 5-min demo
              </a>
